        ...
        <div class="col-md-12">
            <div class="box box-warning">
                <div class="box-header">
                  ...
                  <a href="<?= BASE_URL('produk');?>/add"><button type="button" class="btn bg-blue-active btn-flat pull-right"><span class="glyphicon glyphicon-inbox"></span> Tambah Data</button></a>
                </div>
...
<div id="edit-data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4><b> Apakah Anda yakin ingin mengedit data Produk ini ? </b></h4>
                    </div>
                     <div class="modal-footer">
