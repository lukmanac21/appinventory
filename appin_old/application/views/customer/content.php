      ...
      <div class="row">
            ...
            <div class="box box-warning">
                <div class="box-header">
                  ...
                  <a href="<?= BASE_URL('customer');?>/add"><button type="button" class="btn bg-blue-active btn-flat pull-right"><span class="glyphicon glyphicon-inbox"></span> Tambah Data</button></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4><b> Apakah Anda yakin ingin mengedit data Customer ini ? </b></h4>
                    </div>
