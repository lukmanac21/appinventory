                    ...
                    <div class="box-body table-responsive ">
                        <table class="table table-hover table-striped" id="tabel_barang">
                            ...
                            <tr id="barang_0" style="display: none;" data-id="0">
                                ...
                                <td>
                                    <input type="text" value="0"  class="form-control money-input" placeholder="Biaya Simpan Per Produk" name="biaya_0" id="biaya_0">
                                </td>
                                <td>
                            ...
                            <tr id="barang_<?= $no?>" data-id="<?= $no ?>">
                                ...
                                <td>
                                    <input type="number" value="<?=$b['jumlah']?>"  class="form-control" placeholder="jumlah" name="jumlah_<?= $no?>" id="jumlah_<?= $no?>" onchange="getTotalHargaItem('id_barang_1')">
                                </td>
                                <td>
                                    <input type="text" value="<?=number_format($b['biaya_simpan'] , 0 , "." , ".")?>"  class="form-control money-input" placeholder="Biaya Simpan Per Produk" name="biaya_<?= $no?>" id="biaya_<?= $no?>">
                                </td>
                                <td>
