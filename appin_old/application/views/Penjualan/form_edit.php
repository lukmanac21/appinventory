                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">                  
                                ...
                                <div class="col-sm-9">
                                    <select id="id_supplier" name="supplier_id" class="form-control select2" >
                                        <option value="0">-- Pilih Supplier --</option>
                                            ...
                                            <option value="<?=$l->id?>" <?= $transaksi['id_supplier'] == $l->id ? 'selected':'' ;?>> <?=$l->nama?></option>
                                            <?php endforeach; ?>
                                   </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="ket" rows="3" id="ket" placeholder="isi Keterangan Penjualan ..." required=""></textarea> 
                                </div>
                            </div>
