                ...
                <div class="box-body">
                  <form action="<?php echo $base_url; ?>save" method="post" id="formAuthor">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Harga</label>
                       <input type="text" class="form-control money-input" maxlength="11" placeholder="Harga Jenis Kain" value="<?= $data['harga_barang'] ? $data['harga_barang'] : 0 ;?>" name="harga" id="harga" required="">
