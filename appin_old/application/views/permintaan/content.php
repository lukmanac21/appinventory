      ...
      <div class="row">
            ...
            <div class="box box-warning">
                <div class="box-header">
                  ...
                  <a href="<?= BASE_URL('permintaan');?>/add"><button type="button" class="btn bg-blue-active btn-flat pull-right"><span class="glyphicon glyphicon-inbox"></span> Tambah Data</button></a>
                    ...
                    <div class="box-body">
                     ...
                     <table class="table table-hover table-striped" id="datatable">
                        <thead>
                            <tr>
                                <th>Tanggal</th>
                                <th>Jenis Kain dan Jumlah Permintaan</th>
                                <th>Status</th>
                                <th>Action</th>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4><b> Apakah Anda yakin ingin menghapus data Permintaan ini ? </b></h4>
                    </div>
        ...
        <div id="update-data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4><b> Apakah Anda yakin ingin mengupdate data Permintaan ini ? </b></h4>
                    </div>
                    <div class="modal-footer">
        ...
        <div id="edit-data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4><b> Apakah Anda yakin ingin mengedit data Pemesanan ini ? </b></h4>
                    </div>
                     <div class="modal-footer">
