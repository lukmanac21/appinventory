...
//        $this->db->where('mst_jenis_tindakan_op.status =',1);
    ...
    public function delete($id) {
     ...
     private function _get_datatables_query() {
        $this->db->select('mst_kain.article,mst_jenis.nama as nama_kain,mst_produk.nama,mst_produk.ukuran,'
                . 'mst_produk.id,mst_produk.harga,mst_produk.createddate,mst_produk.createdby');
        $this->db->from($this->table);
        $this->db->join('mst_kain','mst_kain.id = mst_produk.id_kain','left');
