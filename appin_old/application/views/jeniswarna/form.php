        ...
        <div class="col-md-4">
            <div class="box box-success">
                <div class="box-header">
                  <h3 class="box-title" id="form-head"><?= $data['id'] ? 'Edit Jenis Warna' : 'Tambah Jenis Warna';?></h3>
                </div>
                <div class="box-body">
                  <form action="<?php echo $base_url; ?>save" method="post" id="formAuthor">
                   ...
                   <div class="form-group">
                        <label>Nama*</label>
                        <input type="text" class="form-control" placeholder="Nama Jenis Warna" name="nama" id="nama" value="<?= $data['nama'] ? $data['nama'] : '';?>" required="required">
                        <p class="help-block">Nama Jenis Alat</p>
                    </div>
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary">Submit</button> 
                        <a href="<?php echo BASE_URL('warna');?>"><button type="button"  id="batal" class="btn btn-danger">Batal </button></a>
