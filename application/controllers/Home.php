...
class Home extends MY_Controller {
    ...
    var $meta_title = "TSUKAMOTO | Home";
    var $meta_desc = "TSUKAMOTO";
    var $main_title = "Home";
    var $base_url = "";
    var $upload_dir = "";
    var $upload_url = "";
    ...
    private function _home() {        
        ...
        $dt['pesanan'] = $this->Home_model->getPemesanan();
        $dt['pemasukan'] = $this->Home_model->getPemasukan();
        $dt['permintaan'] = $this->Home_model->getPermintaan();
        $dt['pengeluaran'] = $this->Home_model->getPengeluaran();
//        echoPre($dt['pesanan']);exit;
