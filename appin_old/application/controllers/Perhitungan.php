...
//     public function getSearchHitung(){
//        $post = $this->input->post();
//        $idbarang = $post['barang'];
//        $permintaan_barang = $post['permintaan_barang'];
//        $biaya_pesan = $post['biaya_pesan'];
//        $biaya_simpan = $post['biaya'];
//        
//        $dtStart = $post['date1'];
//        $dtEnd = $post['date2'];
//        $tgl = array();
...
//        }
//         if ($idbarang == 'all'){
//                 $dataSearch = $this->perhitungan_model->getDataall($tgl);
