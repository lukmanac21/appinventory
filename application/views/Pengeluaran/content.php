      ...
      <div class="row">
            ...
            <div class="box box-warning">
                <div class="box-header">
                  ...
                  <a href="<?= BASE_URL('pengeluaran');?>/add"><button type="button" class="btn bg-blue-active btn-flat pull-right"><span class="glyphicon glyphicon-inbox"></span> Tambah Data</button></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4><b> Apakah Anda yakin ingin menghapus data Pengeluaran ini ? </b></h4>
                    </div>
        ...
        <div id="update-data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4><b> Apakah Anda yakin ingin mengupdate data Pengeluaran ini ? </b></h4>
                    </div>
                    <div class="modal-footer">
        ...
        <div id="edit-data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4><b> Apakah Anda yakin ingin mengedit data Pengeluaran ini ? </b></h4>
                    </div>
                     <div class="modal-footer">
