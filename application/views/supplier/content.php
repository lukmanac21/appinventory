      ...
      <div class="row">
            ...
            <div class="box box-warning">
                <div class="box-header">
                  <h3 class="box-title">List Data Master Supplier</h3> 
                  <a href="<?= BASE_URL('supplier');?>/add"><button type="button" class="btn bg-blue-active btn-flat pull-right"><span class="glyphicon glyphicon-inbox"></span> Tambah Data</button></a>
        ...
        <div id="edit-data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4><b> Apakah Anda yakin ingin mengedit data Supplier ini ? </b></h4>
                    </div>
                     <div class="modal-footer">
