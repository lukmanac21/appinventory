...
<!--        <div class="col-md-4">
            <div class="box box-success">
                <div class="box-header">
                  <h3 class="box-title" id="form-head">Tambah Kain</h3>
                </div>
                <div class="box-body">
                  <form action="<?php echo $base_url; ?>save" method="post" id="formPengguna">
                   ...
                   <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Code Kain"  value="<?= $code ;?>" name="code" id="code">
                        <p class="help-block">Code Aturan</p>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label id="pass_label">Kategori Warna</label>
                        <select id="kategori_warna" name="warna" class="form-control select2">
                             <option>-- Pilih Kategori Kain --</option>
                            <?php $lv = array(); ?>
                            <?php foreach($kotoran as $l):?>
                            <option value="<?=$l['id']?>">
                    ...
                    <div class="form-group">
                        <label id="pass_label">Satuan</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control money-input" maxlength="11" placeholder="Harga Kain" name="harga" id="harga" required="">
                        <p class="help-block">Code Aturan</p>
                    </div>
                    <div class="form-group">
                        <label>Stok Kain</label>
                        <input type="text" class="form-control" placeholder="Stok Kain" name="stok" id="stok" required="">
                        <p class="help-block">Code Aturan</p>
                    </div>
        ...
        <div class="col-md-12">
            <div class="box box-warning">
                <div class="box-header">
                  <h3 class="box-title">List Data Kain</h3>
                  <a href="<?= BASE_URL('kain');?>/add"><button type="button" class="btn bg-blue-active btn-flat pull-right"><span class="glyphicon glyphicon-inbox"></span> Tambah Data</button></a>
                </div>
...
<div id="edit-data" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4><b> Apakah Anda yakin ingin mengedit data Produk Kain ini ? </b></h4>
                    </div>
                     <div class="modal-footer">
